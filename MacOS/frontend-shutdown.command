# frontend-shutdown.command (macOS)
#!/usr/bin/env sh
# Thorlabs TDC001 FRONTEND shutdown script – macOS
# Stops (and optionally removes) the frontend (GUI) Docker container
...
echo
printf "%s──── stopping TDC001 FRONTEND ────%s\n\n" "$(printf '\033[36m')" "$(printf '\033[0m')"
